...
//   logger.info(`All lexicographic string combination in order.`);
//   logger.info(`Start ASCII code: "${lex.startCode}"`);
//   logger.info(`End ASCII code: "${lex.endCode}"`);
//   logger.info(`Max string width: ${lex.maxStrWidth}`);
//   logger.info(`Total String Combination Count: ${lex.size()}\n`);
//   logger.info('Table:');
//   logger.info(hr);
//   for (let i = 0; i < lex.size(); i += 1) {
//     const str = lex.get(i);
//     if (str) {
//       logger.info(formattedLine(i, padRight(str, lex.maxStrWidth, '_')));
//     }
//   }
//   logger.info(hr);
// };
...
// printLex(lex);
// logger.info(lex.size());
// logger.info(lex.nBetween(8, ' ', '~~~~~'));
// logger.info(lex.between('a', 'ccc'));
// logger.info(lex.get(11));
// logger.info(lex.get(11) === 'aaac');

// const lex4 = new ASCIILexicalTable(' '.charCodeAt(0), '~'.charCodeAt(0), 5);
// logger.info('Size: ', lex4.size());
// logger.info('Between: ', lex4.between('7g7g5', 'caccc'));
// printLex(lex4);
...
//   logger.info(lexT.size());
//   const str = 'bcbba';
//   const strI = lexT.index(str);
//   logger.info('================');
//   console.time('index');
//   logger.info(lexT.index(str));
...
//   logger.info(lexT.between(str, 'cbbca'));
//   for (let i = 0; i < loopLength; i += 1) {
...
// logger.info(orderKeys(lex, keys));
